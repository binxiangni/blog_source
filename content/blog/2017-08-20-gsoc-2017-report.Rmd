...
The source codes of RcppArmadillo is stored in [Github](https://github.com/RcppCore/RcppArmadillo). Below are all the merged pull requests committed by me during [Google Summer of Code](https://developers.google.com/open-source/gsoc/):

* [Add support for dtCMatrix and dsCMatrix](https://github.com/RcppCore/RcppArmadillo/pull/135/files). 
* [Add conversion and unit tests for dgT, dtT and dsTMatrix](https://github.com/RcppCore/RcppArmadillo/pull/136/files).
* [Add conversion and unit tests for dgR, dtR and dsRMatrix](https://github.com/RcppCore/RcppArmadillo/pull/139/files).
* [Add conversion and unit tests for pMatrix and ddiMatrix](https://github.com/RcppCore/RcppArmadillo/pull/140/files).
* [Rewrite conversion for dgT, dtT and dsTMatrix, and add file-based tests](https://github.com/RcppCore/RcppArmadillo/pull/142/files).
* [Add conversion and unit tests for indMatrix](https://github.com/RcppCore/RcppArmadillo/pull/144/files).
* [Rewrite conversion for ddiMatrix](https://github.com/RcppCore/RcppArmadillo/pull/145/files).
* [Add a warning message for matrices that cannot be converted](https://github.com/RcppCore/RcppArmadillo/pull/147/files).
* [Add new vignette for sparse matrix support](https://github.com/RcppCore/RcppArmadillo/pull/152/files).
* [Add support for sparse matrix conversion from Python SciPy](https://github.com/RcppCore/RcppArmadillo/pull/158/files).
...
* Rcpp uses 'proxy models', which may lead to a considerable copying cost when working with `Rcpp::IntegerVector` rather than  `std::vector<int>`.  [Reason](https://github.com/RcppCore/RcppArmadillo/pull/140#pullrequestreview-45318881).
...
### Package
The R package version [RcppArmadillo 0.7.960.1.1](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) with enhanced sparse matrix support has been released to CRAN. You can have access to it by `install.packages("RcppArmadillo")` in R.  
...
## Future
Although the end of GSOC approaches, I will continue contributing to sparse matrix support in RcppArmadillo in the future. Recently, there will be a new [compatibility](https://github.com/conradsnicta/armadillo-code/issues/13) for [COO](https://en.wikipedia.org/wiki/Sparse_matrix#Coordinate_list_.28COO.29) format in Armadillo, more sparse matrix conversion will be needed on the side of RcppArmadillo. 
